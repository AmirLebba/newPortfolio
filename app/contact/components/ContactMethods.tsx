      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="contact-card scroll-reveal">
            ...
            <button onClick={() => copyToClipboard('alex.chen@example.com')} className="text-blue-400 hover:text-blue-300">Copy Email</button>
          </div>
          ...
          <div className="contact-card scroll-reveal">
            ...
            <button onClick={() => copyToClipboard('+1 (555) 123-4567')} className="text-blue-400 hover:text-blue-300">Copy Number</button>
          </div>
