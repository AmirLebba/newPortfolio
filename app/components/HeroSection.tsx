...
export default function HeroSection() {
  ...
  useEffect(() => {
    const animateCounters = () => {
      [
        { target: 2, key: "experience" },
        { target: 10, key: "projects" },
        { target: 9, key: "technologies" },
      ].forEach(({ target, key }) => {
        let current = 0;
        const inc = target / 50;
        const t = setInterval(() => {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center pt-20 px-6 bg-gradient-to-br from-deep-charcoal via-gray-900 to-black relative overflow-hidden">
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(circle at 20% 50%, #00d4ff 0%, transparent 50%), radial-gradient(circle at 80% 20%, #39ff14 0%, transparent 50%), radial-gradient(circle at 40% 80%, #bd93f9 0%, transparent 50%)",
        }}
      />
        ...
        <div className="space-y-8">
          ...
          <ScrollReveal delay={400}>
            <p className="text-lg text-gray-400 leading-relaxed max-w-lg">
              ...
              with intuitive design. Specializing in modern web applications, I
          ...
          <ScrollReveal delay={600}>
            <div className="flex flex-wrap gap-4">
              <button
                ...
                className="px-8 py-3 bg-electric-blue hover:bg-blue-700 text-deep-charcoal rounded-lg font-semibold transition-all duration-300 border border-electric-blue hover:shadow-lg hover:shadow-electric-blue/30"
              >
                View Projects
              </button>
              <button
                onClick={() => router.push("/contact")}
                className="px-8 py-3 border border-electric-blue text-electric-blue hover:bg-electric-blue hover:text-deep-charcoal rounded-lg font-semibold transition-all duration-300"
              >
                Get In Touch
              </button>
            </div>
          ...
          <div className="floating-element">
            <div className="code-editor bg-dark-gray rounded-xl p-8 relative overflow-hidden shadow-2xl shadow-electric-blue/10">
              ...
              <div className="mt-8 space-y-4 font-mono text-sm">
                ...
                <div>
                  <span className="text-electric-blue">const </span>
                  <span className="text-white">developer</span>
                ...
                <div>
                  <span className="text-purple">console.log</span>
                  <span className="text-white">(</span>
                  <span className="text-orange-400">
