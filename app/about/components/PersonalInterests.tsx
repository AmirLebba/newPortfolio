  ...
  const interests = [
    {
      emoji: "🚀",
      title: "Open Source",
      text: "Contributing to open source projects and building tools that help other developers.",
    },
    {
      emoji: "📚",
      title: "Mentoring",
      text: "Sharing knowledge through tech talks, workshops, and mentoring junior developers.",
    },
    {
      emoji: "🎨",
      title: "UI/UX Design",
      text: "Exploring the intersection of code and design to create beautiful, functional interfaces.",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {interests.map((i) => (
            <div
              key={i.title}
              className="bg-gray-800 rounded-lg p-6 text-center scroll-reveal"
            >
              <ScrollReveal>
