            ...
            <div className="timeline-item scroll-reveal">
              <div className="bg-gray-800 rounded-lg p-6">
                ...
                <p className="text-gray-300 mb-4">
                  Leading development of enterprise web applications serving
          ...
          <ScrollReveal>
            <div className="timeline-item scroll-reveal">
              <div className="bg-gray-800 rounded-lg p-6">
                ...
                <p className="text-gray-300 mb-4">
                  Built scalable web applications from ground up. Developed
                  real-time features and integrated third-party APIs. Mentored
          ...
          <ScrollReveal>
            <div className="timeline-item scroll-reveal">
              <div className="bg-gray-800 rounded-lg p-6">
                ...
                <p className="text-gray-300 mb-4">
                  Created responsive web interfaces for diverse clients.
                  Optimized performance and accessibility. Collaborated with
